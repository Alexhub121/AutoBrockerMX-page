...
export function LogoEmblem({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "inline-flex items-center justify-center rounded-full border border-border bg-linear-to-b from-secondary to-background font-brand font-extrabold not-italic shadow-inner",
        className,
      )}
      aria-hidden="true"
    >
